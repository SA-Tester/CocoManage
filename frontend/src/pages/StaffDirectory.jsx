...
const StaffDirectory = () => {
    ...
    const currentStaffPage = filteredStaff.slice(indexOfFirstStaff, indexOfLastStaff);
    ...
    return (
        <div className="flex flex-col justify-between bg-green lg:flex-row p-8 text-white lg:items-center gap-8 absolute left-0 w-full h-full">
                ...
                <div className="flex flex-row items-center gap-12">
                    <form className='w-80 relative'>
                        <div className="relative">
                            ...
                            />
                            <button type="button" className="absolute right-1 top-1/2 -translate-y-1/2 p-4 rounded-full">
            ...
            <Modal show={showAddModal} size="md" popup onClose={() => setShowAddModal(false)}>
                <Modal.Header />
                <Modal.Body>
                    <div className="space-y-6">
                        <h3 className="text-xl font-medium text-gray-900">Add New Staff Member</h3>
                        <div>
            ...
            <Modal show={showEditModal} size="md" popup onClose={() => setShowEditModal(false)}>
                <Modal.Header />
                <Modal.Body>
                    <div className="space-y-6">
                        <h3 className="text-xl font-medium text-gray-900">Edit Staff Member</h3>
                        <div>
