...
urlpatterns = [
    ...
    path('get_rainfall_data/', views.GetRainfallDataView.as_view(), name='get_rainfall_data'),
    path('get_temperature_data/', views.GetTemperatureDataView.as_view(), name='get_temperature_data'),
    path('get_humidity_data/', views.GetHumidityDataView.as_view(), name='get_humidity_data'),
    path('get_soil_moisture_data/', views.GetSoilMoistureDataView.as_view(), name='get_soil_moisture_data'),
